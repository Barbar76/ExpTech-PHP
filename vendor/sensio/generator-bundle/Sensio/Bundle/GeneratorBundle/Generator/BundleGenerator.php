...
class BundleGenerator extends Generator
{
    ...
    public function generate($namespace, $bundle, $dir, $format, $structure)
    {
        ...
        $this->renderFile('bundle/MainController.php.twig', $dir.'/Controller/MainController.php', $parameters);
        $this->renderFile('bundle/DefaultControllerTest.php.twig', $dir.'/Tests/Controller/DefaultControllerTest.php', $parameters);
        $this->renderFile('bundle/layout.main.html.twig.twig', $dir.'/Resources/views/Default/layout.main.html.twig', $parameters);
