 ...
 */
class GdCities extends \ORM\MainBundle\Entity\GdCities implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'cityId', 'countrySlug', 'regionSlug', 'city');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GdCities $proxy) {
