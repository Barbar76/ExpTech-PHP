 ...
 */
class GdCountries extends \ORM\MainBundle\Entity\GdCountries implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'country', 'countrySlug');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GdCountries $proxy) {
